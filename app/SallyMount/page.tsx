  ...
  return (
    <div style={{ fontFamily: sans, WebkitFontSmoothing: "antialiased" }}>
      ...
      >
        ...
        >
          Relax & Unwind at SallyMount House.
          <br /><br />
          Make your stay even more special with a realxing massage in the comfort of SallyMount House.
          <br /><br />
          Choose from our curated selection of treatments and let us take care of the rest.
        </p>
      ...
      <section style={{ backgroundColor: CREAM }} className="px-6 py-28">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="py-6 text-center text-xs tracking-wider uppercase font-light" style={{ borderTop: "1px solid rgba(41,21,7,0.13)", color: BROWN, opacity: 0.7 }}>
            All treatments are provided in the comfort of SallyMount House.
          </div>
